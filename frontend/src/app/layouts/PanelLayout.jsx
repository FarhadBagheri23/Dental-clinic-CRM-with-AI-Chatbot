...
const NAV = [
  ...
  { to: "/clinical", label: "طرح درمان و فراخوان", d: "M9 11l2 2 4-4M5 4h14a1 1 0 011 1v14a1 1 0 01-1 1H5a1 1 0 01-1-1V5a1 1 0 011-1z" },
  { to: "/finance", label: "مالی و انبار", d: "M3 10h18M7 15h4M5 6h14a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V8a2 2 0 012-2z" },
  { to: "/profitability", label: "سودآوری و مطالبات", d: "M12 2v20M17 6.5c0-1.9-2.2-3-5-3s-5 1.1-5 3 2.2 2.7 5 3.2 5 1.3 5 3.3-2.2 3-5 3-5-1.1-5-3" },
  ...
  { to: "/assistant", label: "دستیار هوشمند", d: "M12 3a9 9 0 00-9 9c0 1.6.4 3.1 1.2 4.4L3 21l4.6-1.2A9 9 0 1012 3zM8.5 12h.01M12 12h.01M15.5 12h.01" },
];
